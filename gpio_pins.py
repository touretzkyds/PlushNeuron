...
# Dendrite 1
DENDRITE_1_ROTARY_PINS = [digitalio.DigitalInOut(board.D2),
...
# Dendrite 2
DENDRITE_2_ROTARY_PINS = [digitalio.DigitalInOut(board.D7),
...
# Dendrite 3
DENDRITE_3_ROTARY_PINS = [digitalio.DigitalInOut(board.D5),
